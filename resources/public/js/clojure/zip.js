...
return cljs.core.assoc.call(null,node,new cljs.core.Keyword(null,"content","content",15833224),(function (){var and__21433__auto__ = children;
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_.call(null,loc))){
var vec__31912 = loc;
var node = cljs.core.nth.call(null,vec__31912,(0),null);
var path = cljs.core.nth.call(null,vec__31912,(1),null);
var vec__31915 = clojure.zip.children.call(null,loc);
...
var vec__31923 = loc;
var node = cljs.core.nth.call(null,vec__31923,(0),null);
var map__31926 = cljs.core.nth.call(null,vec__31923,(1),null);
...
var path = map__31926__$1;
var l = cljs.core.get.call(null,map__31926__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.call(null,map__31926__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.call(null,map__31926__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.call(null,map__31926__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.call(null,map__31926__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
if(cljs.core.truth_(pnodes)){
var pnode = cljs.core.peek.call(null,pnodes);
return cljs.core.with_meta.call(null,(cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,pnode,cljs.core.concat.call(null,l,cljs.core.cons.call(null,node,r))),(function (){var and__21433__auto__ = ppath;
if(cljs.core.truth_(and__21433__auto__)){
...
var vec__31941 = cljs.core.get.call(null,map__31940__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var r = first__31943;
var rnext = seq__31942__$1;
var rs = vec__31941;
if(cljs.core.truth_((function (){var and__21433__auto__ = path;
if(cljs.core.truth_(and__21433__auto__)){
return rs;
} else {
return and__21433__auto__;
...
var vec__31950 = loc;
var node = cljs.core.nth.call(null,vec__31950,(0),null);
var map__31953 = cljs.core.nth.call(null,vec__31950,(1),null);
var map__31953__$1 = ((((!((map__31953 == null)))?((((map__31953.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31953.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31953):map__31953);
var path = map__31953__$1;
var l = cljs.core.get.call(null,map__31953__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__31953__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__21433__auto__ = path;
if(cljs.core.truth_(and__21433__auto__)){
return r;
} else {
...
var vec__31960 = loc;
var node = cljs.core.nth.call(null,vec__31960,(0),null);
var map__31963 = cljs.core.nth.call(null,vec__31960,(1),null);
...
var path = map__31963__$1;
var l = cljs.core.get.call(null,map__31963__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__31963__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__21433__auto__ = path;
if(cljs.core.truth_(and__21433__auto__)){
...
var vec__31970 = loc;
var node = cljs.core.nth.call(null,vec__31970,(0),null);
var map__31973 = cljs.core.nth.call(null,vec__31970,(1),null);
...
var path = map__31973__$1;
var l = cljs.core.get.call(null,map__31973__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__31973__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__21433__auto__ = path;
if(cljs.core.truth_(and__21433__auto__)){
return cljs.core.seq.call(null,l);
} else {
...
var vec__31980 = loc;
var node = cljs.core.nth.call(null,vec__31980,(0),null);
var map__31983 = cljs.core.nth.call(null,vec__31980,(1),null);
...
var path = map__31983__$1;
var l = cljs.core.get.call(null,map__31983__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__31990 = loc;
var node = cljs.core.nth.call(null,vec__31990,(0),null);
var map__31993 = cljs.core.nth.call(null,vec__31990,(1),null);
var map__31993__$1 = ((((!((map__31993 == null)))?((((map__31993.cljs$lang$protocol_mask$partition0$ & (64))) || (map__31993.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31993):map__31993);
var path = map__31993__$1;
var r = cljs.core.get.call(null,map__31993__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__31998 = loc;
var _ = cljs.core.nth.call(null,vec__31998,(0),null);
var path = cljs.core.nth.call(null,vec__31998,(1),null);
...
var len__22628__auto___32004 = arguments.length;
var i__22629__auto___32005 = (0);
while(true){
if((i__22629__auto___32005 < len__22628__auto___32004)){
args__22635__auto__.push((arguments[i__22629__auto___32005]));

var G__32006 = (i__22629__auto___32005 + (1));
i__22629__auto___32005 = G__32006;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__22636__auto__);
});
...
clojure.zip.edit.cljs$lang$applyTo = (function (seq32001){
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(G__32002,G__32003,seq32001__$2);
});
...
var or__21445__auto__ = (function (){var and__21433__auto__ = clojure.zip.branch_QMARK_.call(null,loc);
if(cljs.core.truth_(and__21433__auto__)){
...
var or__21445__auto____$1 = clojure.zip.right.call(null,loc);
...
var or__21445__auto____$2 = clojure.zip.right.call(null,clojure.zip.up.call(null,p));
if(cljs.core.truth_(or__21445__auto____$2)){
return or__21445__auto____$2;
} else {
var G__32007 = clojure.zip.up.call(null,p);
p = G__32007;
continue;
}
} else {
...
var loc__$1 = lloc;
while(true){
var temp__6501__auto____$1 = (function (){var and__21433__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);
if(cljs.core.truth_(and__21433__auto__)){
...
var G__32008 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__32008;
continue;
} else {
return loc__$1;
...
var vec__32014 = loc;
var node = cljs.core.nth.call(null,vec__32014,(0),null);
var map__32017 = cljs.core.nth.call(null,vec__32014,(1),null);
...
var path = map__32017__$1;
var l = cljs.core.get.call(null,map__32017__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.call(null,map__32017__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.call(null,map__32017__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.call(null,map__32017__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__6501__auto__ = (function (){var and__21433__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);
if(cljs.core.truth_(and__21433__auto__)){
return clojure.zip.down.call(null,loc__$1);
} else {
return and__21433__auto__;
...
var G__32019 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__32019;
continue;
} else {
return loc__$1;
...
return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,cljs.core.peek.call(null,pnodes),rs),(function (){var and__21433__auto__ = ppath;
if(cljs.core.truth_(and__21433__auto__)){
return cljs.core.assoc.call(null,ppath,new cljs.core.Keyword(null,"changed?","changed?",-437828330),true);
} else {
return and__21433__auto__;
...
//# sourceMappingURL=zip.js.map?rel=1470139190345