...
var and__21578__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__21578__auto__){
var and__21578__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__21578__auto____$1)){
var and__21578__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__59856){
var map__59859 = p__59856;
var map__59859__$1 = ((((!((map__59859 == null)))?((((map__59859.cljs$lang$protocol_mask$partition0$ & (64))) || (map__59859.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59859):map__59859);
var opts = map__59859__$1;
var retry_count = cljs.core.get.call(null,map__59859__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__59859__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__59859__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__59859__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__6550__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__6550__auto__)){
var WebSocket = temp__6550__auto__;
...
socket.onmessage = ((function (url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__6552__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__6552__auto__)){
var msg = temp__6552__auto__;
...
});})(url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__21590__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__21930__auto__ = (10000);
var y__21931__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__6550__auto__,map__59859,map__59859__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1471999082333